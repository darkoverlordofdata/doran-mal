...
public struct bool {
	...
	public static bool TryParse (string str, out bool result = null) {
		if (str == "true") {
			result = true;
			return true;
		} else if (str == "false") {
...
public class string {
	...
	public string[] Split (string delimiter, int maxTokens = 0);
	[Version (since = "2.4")]
	[CCode (cname = "g_strsplit_set", array_length = false, array_null_terminated = true)]
	public string[] SplitSet (string delimiters, int max_tokens = 0);
	[CCode (cname = "g_stpcpy")]
	private static void* CopyToBuffer (void* dest, string src);
	...
	public static string Joinv (string? separator, string?[]? str_array) {
		...
		if (str_array != null || str_array.length > 0 || (str_array.length == -1 && str_array[0] != null)) {
			...
			void* ptr = string.CopyToBuffer ((void*) res, (!) str_array[0]);
			for (i = 1 ; i < str_array.length ; i++) {
				ptr = string.CopyToBuffer (ptr, (!) separator);
				ptr = string.CopyToBuffer (ptr, (str_array[i] != null) ? ((!) str_array[i]) : "");
			}
...
//  	/* File Utilities */
	...
	public class GenericSet<T> {
		...
		[CCode (cname = "g_hash_table_add")]
		public void Add (owned T value);
		[CCode (cname = "g_hash_table_contains")]
		public bool Contains (T valule);
		[CCode (cname = "g_hash_table_remove")]
		public bool Remove (T value);
		[CCode (cname = "g_hash_table_remove_all")]
		public void RemoveAll ();
		[CCode (cname = "g_hash_table_get_values")]
		public GLib.List<unowned T> GetValues ();
	...
	public class StringBuilder {
		...
		[CCode (cname = "g_string_insert_unichar")]
		public unowned StringBuilder InsertUniChar (ssize_t pos, unichar wc);
		[Version (since = "2.14")]
	...
	public class Bytes {
		...
		[CCode (cname = "g_bytes_get_data", array_length_type = "gsize")]
		public unowned uint8[] GetData ();
		[CCode (cname = "g_bytes_get_size")]
		...
		public uint8 get (int index) {
			unowned uint8[] data = this.GetData ();
			return data[index];
		}
